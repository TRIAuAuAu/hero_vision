...
public:
  ...
  Eigen::Matrix<double,MEASUREMENT_DIM, 1> measurement;

  Eigen::Matrix<double,STATE_DIM, 1> target_state;
...
private:
  ...
  Eigen::Vector3d getArmorPositionFromState(const Eigen::Matrix<double, STATE_DIM, 1> & x);
